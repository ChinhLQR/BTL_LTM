...
void on_Btn_PopUpChat_clicked()
{
 ...
 // GtkWidget *label_chat_name = GTK_WIDGET(gtk_builder_get_object(builder, "Label_Chat_Name"));
  
 //gtk_entry_get_text(entry_friend);
  //gtk_label_set_text(GTK_LABEL(label_chat_name),entry_friend);
